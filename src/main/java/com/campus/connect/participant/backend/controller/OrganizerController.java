...
public class OrganizerController {
    ...
    @GetMapping("/getOrganizerBySocietyId")
    public List<Organizer> getOrganizerBySocietyId(@RequestParam UUID societyId) {

        return organizerRepository.getOrganizerBySocietyId(societyId);
    }
